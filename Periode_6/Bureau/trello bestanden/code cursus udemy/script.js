...
variables
2. Calcuate both their BMIs
3. Create a boolean variable containing information
about wheter Mark has a higher BMI than John.
4. Print a string to the console containing the variable from step3. (Something like "Is Mark's BMI higher than John's? true").
...
//scores
var aScoreJohn = 89, bScoreJohn = 120, cScoreJohn = 103;
var aScoreMike = 116, bScoreMike = 94, cScoreMike = 123;
//var aScoreMary = 97, bScoreMary = 134, cScoreMary = 105;
var AverageScoreJohn = (aScoreJohn + bScoreJohn + cScoreJohn) / 3;
var AverageScoreMike = (aScoreMike + bScoreMike + cScoreMike) / 3;
//var AverageScoreMary = (aScoreMary + bScoreMary + cScoreMary) / 3;
...
if(AverageScoreJohn > AverageScoreMike) {
    console.log('John is the average winner with ' + AverageScoreJohn + '.');
} else if(AverageScoreJohn < AverageScoreMike) {
    console.log('Mike is the average winner with ' + AverageScoreMike + '.');
} else  if(AverageScoreJohn === AverageScoreMike) {
    console.log('It\'s a draw');
}


//With Mary in progress
/*
if(AverageScoreJohn && AverageScoreMary > AverageScoreMike) {
    console.log('');
} else if(AverageScoreJohn && AverageScoreMary < AverageScoreMike) {
    console.log('Mike is the average winner');
} else  if(AverageScoreJohn === AverageScoreMike) {
    console.log('It\'s a draw');
}
*/
...
/*
John and his family went on a holiday and wenyt to 3
different restaurants. THe bills where $124, $48 and 
$268.

To tip the waiter a fair amount, John created a
simple tip calculator (as a function). He likes to
tip 20% of the bill whe the bill is less than $50,
15% when the bill is between $50 and $200 and 10%
if the bull is more than $200.

In the end, John would like to have 2 arrays:
1) Containing all three tips (one for each bill)
2) Containing al three final paid amounts (bill + tip).
...
// rekening uitroepen uit array bills[0]
